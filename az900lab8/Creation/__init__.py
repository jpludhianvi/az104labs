...
def create_user(tenant_id, client_id, client_secret, scope, subscription_id, resource_group_location, username, password):
    ...
    # "Microsoft.Storage/storageAccounts/blobServices/containers/blobs/properties/write",
    # "Microsoft.Storage/storageAccounts/blobServices/containers/blobs/metadata/read",
    # "Microsoft.Storage/storageAccounts/blobServices/containers/blobs/metadata/write"
        ],
        not_actions=[
        ]
    )
